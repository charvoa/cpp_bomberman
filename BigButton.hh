...
// Last update Fri May 22 17:46:23 2015 Nicolas Charvoz
//

#ifndef BIGBUTTON_HH_
# define BIGBUTTON_HH_

# include "AObject.hh"

class BigButton : public AObject
{
private:
...
public:
  ...
  virtual bool initialize(const std::string &tex)
  {
    ...
    _geometry.pushVertex(glm::vec3(0.35, 0.21, 0.5));
    _geometry.pushVertex(glm::vec3(0.35, -0.21, 0.5));
    _geometry.pushVertex(glm::vec3(-0.35, -0.21, 0.5));
    _geometry.pushVertex(glm::vec3(-0.35, 0.21, 0.5));

//
// SDLGLUtilis.cpp for  in /home/nicolaschr/Work/cpp_bomberman
//
// Made by Nicolas Charvoz
// Login   <nicolaschr@epitech.net>
//
// Started on  Tue May 12 11:02:01 2015 Nicolas Charvoz
// Last update Tue May 12 11:06:44 2015 Nicolas Charvoz
//
...
GLuint LoadTexture::LoadImageTexture(const char * filename,bool useMipMap)
{
    GLuint glID;
...
int LoadTexture::takeScreenshot(const char * filename)
{
    GLint viewport[4];
    Uint32 rmask, gmask, bmask, amask;
...
SDL_Surface *LoadTexture::flipSurface(SDL_Surface * surface)
{
...
void LoadTexture::drawAxis(double scale)
{
...
int LoadTexture::initFullScreen(unsigned int * width,unsigned int * height)
{
    SDL_Rect **modes;
...
int LoadTexture::XPMFromImage(const char * imagefile, const char * XPMfile)
{
...
SDL_Cursor *LoadTexture::cursorFromXPM(const char * xpm[])
{
    int i, row, col;
    int width, height;
    Uint8 * data;
